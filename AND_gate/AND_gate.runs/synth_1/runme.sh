...
HD_PWD='/home/lsriw/SR/BodziochKonrad/AND_gate/AND_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_and_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_and_gate.tcl
