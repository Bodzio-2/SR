...
HD_PWD='C:/Users/dunge/Desktop/Systemy Rekonfigurowalne/Lab5/hdmi_vga_zybo/hdmi_vga_zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_hdmi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_hdmi.tcl -notrace
