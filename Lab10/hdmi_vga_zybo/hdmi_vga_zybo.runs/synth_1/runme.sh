...
HD_PWD='C:/Users/dunge/Desktop/Systemy Rekonfigurowalne/Lab5/hdmi_vga_zybo/hdmi_vga_zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_hdmi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_hdmi.tcl
