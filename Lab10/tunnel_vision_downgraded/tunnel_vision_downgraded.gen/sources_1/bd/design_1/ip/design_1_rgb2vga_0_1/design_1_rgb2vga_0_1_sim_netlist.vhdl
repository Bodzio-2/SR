...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_rgb2vga_0_1 -prefix
--               design_1_rgb2vga_0_1_ design_1_rgb2vga_0_0_sim_netlist.vhdl
...
entity design_1_rgb2vga_0_1_rgb2vga is
  port (
...
end design_1_rgb2vga_0_1_rgb2vga;

architecture STRUCTURE of design_1_rgb2vga_0_1_rgb2vga is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_rgb2vga_0_1 is
  port (
  ...
  attribute NotValidForBitStream of design_1_rgb2vga_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_rgb2vga_0_1 : entity is "design_1_rgb2vga_0_0,rgb2vga,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_rgb2vga_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_rgb2vga_0_1 : entity is "rgb2vga,Vivado 2023.2";
end design_1_rgb2vga_0_1;

architecture STRUCTURE of design_1_rgb2vga_0_1 is
  attribute x_interface_info : string;
  attribute x_interface_info of PixelClk : signal is "xilinx.com:signal:clock:1.0 signal_clock CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of PixelClk : signal is "XIL_INTERFACENAME signal_clock, ASSOCIATED_BUSIF vid_in, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_dvi2rgb_0_0_PixelClk, INSERT_VIP 0";
...
begin
U0: entity work.design_1_rgb2vga_0_1_rgb2vga
     port map (
      PixelClk => PixelClk,
