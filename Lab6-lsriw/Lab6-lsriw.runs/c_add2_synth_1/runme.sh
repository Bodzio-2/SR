...
HD_PWD='/home/lsriw/SR/BodziochKonrad/SR/Lab6-lsriw/Lab6-lsriw.runs/c_add2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_add2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_add2.tcl
